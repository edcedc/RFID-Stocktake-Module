...
import kotlinx.android.synthetic.main.include_top.toolbar
...
class MainActivity : BaseActivity(), MainContract.View, IKeyRecv, NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun initView() {
        setTitleCenter(getString(R.string.stocktake), getString(R.string.connecting))
...
//                }
    ...
    fun onStartReceivingEvent(event: StartReceivingEvent?) {
        LogUtils.e("onStartReceivingEvent", event!!.isStart)
        if (event!!.isStart) {
