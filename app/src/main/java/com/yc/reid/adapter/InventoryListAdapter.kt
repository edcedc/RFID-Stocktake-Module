...
class InventoryListAdapter (act: Context, root: BaseFragment, listBean: List<StocktakeListSql>) :
    ...
    override fun onCreateViewHolde(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.i_inventory, parent, false))
    }
    ...
    override fun onBindViewHolde(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.setOnItemClickListener(object : View.OnClickListener{
            override fun onClick(p0: View?) {
                UIHelper.startInventorySearchAct(bean);
            }
        })
    }
