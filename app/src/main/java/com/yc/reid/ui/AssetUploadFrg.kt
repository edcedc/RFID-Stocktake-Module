...
import kotlinx.android.synthetic.main.f_asset_upload.tv_state
 ...
 * @Description
 */
class AssetUploadFrg : BaseFragment(), AssetDetailsContract.View, OnClickListener {
    ...
    override fun initView(rootView: View) {
        ...
        recyclerView.addItemDecoration(GridSpacingItemDecoration( 3,DensityUtil.dip2px(activity, 8f), false))
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            R.id.tv_state ->{
                if (stockChildSql!!.type == INVENTORY_READ)return
