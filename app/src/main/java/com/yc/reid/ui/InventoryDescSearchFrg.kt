...
import kotlinx.android.synthetic.main.f_search.bt_sure
import kotlinx.android.synthetic.main.f_search.layout
import kotlinx.android.synthetic.main.f_search.progress_bar
import kotlinx.android.synthetic.main.f_search.tv_text
 ...
 * @Description 上传
 */
class InventoryDescSearchFrg:BaseFragment(), OnClickListener {
